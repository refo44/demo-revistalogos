...
| [0014](0014-entorno-local-de-desarrollo-docker.md) | Entorno local de desarrollo WordPress con Docker (`wordpress:7.1.0-php8.3-apache`) | Aceptada |
...
| [0021](0021-apellido-bibliografico-y-override-como-citar.md) | Apellido bibliográfico y override opcional de Cómo Citar | Aceptada (implementación IN PROGRESS) |
