...
| `article.authors` → `author.title` (nombre); `author.citation_surname` si existe, si no apellido last-token (ADR 0021) | `journal_article / contributors / person_name` (`given_name`, `surname`) |
