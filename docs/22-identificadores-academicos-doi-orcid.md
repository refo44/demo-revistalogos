...
| `article.authors` → `author.given_names` + (`author.citation_surname` o, si vacío, `author.family_names`); título = nombre público (ADR 0022) | `journal_article / contributors / person_name` (`given_name`, `surname`) |
