...
**Testing Foundation: IMPLEMENTADA** (ADR 0018, `docs/23-testing-foundation.md`, PHPUnit 9.6, `composer test:unit`). ADR 0017 permanece **aceptado**. WU1 (política de dominio pura) y WU2 (adaptador WordPress de solo lectura) están en `revistalogos-core`. **No** hay renderer, **no** hay creación de adjuntos, **no** hay orquestación de publicación. Publicar **sigue** sin exigir PDF. El PDF integral del número sigue siendo carga editorial manual. Ver ADR 0017.
